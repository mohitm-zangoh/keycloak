...
<div class="${properties.kcLogin!}">
  <div class="${properties.kcLoginContainer!}">
    <header id="kc-header" class="pf-v5-c-login__header">
      <div id="kc-header-wrapper" class="pf-v5-c-brand zangoh-logo-container">
        <img src="https://cdn.zangoh.com/images/1782381601490.webp" class="zangoh-logo" alt="Zangoh Logo" />
        <img src="https://cdn.zangoh.com/images/1782381611114.webp" class="zangoh-name" alt="Zangoh" />
      </div>
    </header>
